...
namespace MoBaSteuerung.Anlagenkomponenten {
    ...
    public class AnlagenElemente {
        ...
        private ElementListe<FahrstrasseK> _fahrstrassenKElemente;
        ...
        public Int32 Zoom {
            set {
                ...
                this._fahrstrassenKElemente.Zoom = value;
        ...
        public AnzeigeTyp AnzeigeTyp {
            set {
                ...
                this._fahrstrassenKElemente.AnzeigeTyp = value;
        ...
        public ElementListe<FahrstrasseK> FahrstrassenKElemente {
            get {
                return _fahrstrassenKElemente;
            }
        }
        ...
        public void AlleLöschen() {
            ...
            this._fahrstrassenKElemente.AlleLöschen();
