...
namespace MoBaSteuerung.Anlagenkomponenten
{
	...
	public class MsgBox
  {
    ...
    /// <returns></returns>
    public static DialogResult Show(string test, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
    {
...
#pragma warning restore 0618
      ...
      DialogResult rslt = MessageBox.Show(test, caption, buttons, icon, defaultButton);
