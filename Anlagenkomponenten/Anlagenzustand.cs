...
namespace MoBaSteuerung.Anlagenkomponenten {
	public class BoolArray {
		...
		private List<bool> _changed = new List<bool>();

		public List<bool> Changed {
			get {
				return _changed;
			}
		...
		public bool this[int adresse, int bit] {
			...
			set {
				ushort oldvalue = _value[adresse];
				if (value) {
